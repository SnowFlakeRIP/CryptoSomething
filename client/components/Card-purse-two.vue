<template>
  <div class="card">
    ...
    <div class="card-btn__group">
      ...
      <div class="card-btn__item">
        <button id="two" style="width: 200px; padding-right: 10px">
  ...
  methods: {
    async getPurse() {
      ...
      for (let i = 0; i < purse.data.length; i++) {
        if (purse.data[i].currencies_id === 2) {
...
.card {
  width: 350px;
  height: 207px;
  background: linear-gradient(111.04deg, #ffffff 3.1%, #e5e4e2 89.3%);
  box-shadow: 0px 0px 30px rgba(233, 232, 231, 0.5);
  position: relative;
}
.res-group {
  display: none;
