<template>
  <div class="card" >
    <div class="card-txt" v-for="item in purse_number" v-bind:key="purse_number.id">
      ...
      <div class="card-txt__count">
        ...
        <p class="txt__count">EMG</p>
      </div>
      <div class="card-txt__curent-balance">
        <p class="curent-balance">0,0</p>
        <p class="curent-balance">usd</p>
      </div>
    </div>
    <div class="card-btn__group">
      <div id="1" class="card-btn__item">
        <button>
      ...
      <div class="card-btn__item">
        <button id="two">
          <img class="card-btn__item-transfer" src="img/Swap.svg" alt="1"/>
          Transfer
        </button>
      </div>
    </div>
  ...
  methods: {
    async getPurse() {
      ...
      for (let i = 0; i < purse.data.length; i++) {
        if (purse.data[i].currencies_id === 1) {
          this.purse_number.push(purse.data[i])
        }
      }
      console.log(this.purse_number)
    }
  },
  mounted() {
    this.getPurse()
